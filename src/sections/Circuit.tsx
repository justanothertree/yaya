...
// (Board / Log today; Feed / Charts / Movies to follow). Backed by the shared
// store (localStorage now → Supabase realtime later, no UI change).
...
type Tab = 'board' | 'log' | 'feed' | 'charts' | 'movies'
...
export function Circuit() {
  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', gap: '0.4rem', margin: '0.9rem 0 1.1rem' }}>
        {tabs.map((t) => (
          <button
            key={t.id}
            className="btn"
